...
const generateIndexPage = async (configList) => {
    ...
    if(configList.slide1 == "{None}" || searchArticleList(articleList, configList.slide1) == undefined) {
        ...
        indexPageTemplate = indexPageTemplate.replace("{{slide1Link}}", "cmureadme.com/generated_content/articles/" + article1.articleHash);
    ...
    if(configList.slide2 == "{None}" || searchArticleList(articleList, configList.slide2) == undefined) {
        ...
        indexPageTemplate = indexPageTemplate.replace("{{slide2Link}}", "cmureadme.com/generated_content/articles/" + article1.articleHash);
    ...
    if(configList.slide3 == "{None}" || searchArticleList(articleList, configList.slide3) == undefined) {
        ...
        indexPageTemplate = indexPageTemplate.replace("{{slide3Link}}", "cmureadme.com/generated_content/articles/" + article1.articleHash);
    ...
    if(configList.sideBar1 == "{None}" || searchArticleList(articleList, configList.sideBar1) == undefined) {
        ...
        indexPageTemplate = indexPageTemplate.replace("{{sideBarLink1}}", "cmureadme.com/generated_content/articles/" + article1.articleHash);
    ...
    if(configList.sideBar2 == "{None}" || searchArticleList(articleList, configList.sideBar2) == undefined) { 
        ...
        indexPageTemplate = indexPageTemplate.replace("{{sideBarLink2}}", "cmureadme.com/generated_content/articles/" + article1.articleHash);
    ...
    if(configList.sideBar3 == "{None}" || searchArticleList(articleList, configList.sideBar3) == undefined) {
        ...
        indexPageTemplate = indexPageTemplate.replace("{{sideBarLink3}}", "cmureadme.com/generated_content/articles/" + article1.articleHash);
    ...
    if(configList.bottomBar1 == "{None}" || searchArticleList(articleList, configList.bottomBar1) == undefined) {
        ...
        indexPageTemplate = indexPageTemplate.replace("{{bottom1Link}}", "cmureadme.com/generated_content/articles/" + article1.articleHash);
    ...
    if(configList.bottomBar2 == "{None}" || searchArticleList(articleList, configList.bottomBar2) == undefined) {
        ...
        indexPageTemplate = indexPageTemplate.replace("{{bottom2Link}}", "cmureadme.com/generated_content/articles/" + article1.articleHash);
